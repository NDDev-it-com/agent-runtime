...
func TestRejectsCompatibilityLaneDrift(t *testing.T) {
	t.Parallel()
	c := testContract()
	workflow := strings.Replace(testWorkflow("1.25.x"), "test:\n    go-version: '1.24.x'", "test:\n    go-version: '1.25.x'", 1)
...
func testContract() Contract {
	return Contract{SchemaVersion: "v1alpha1", License: "AGPL-3.0-only", Govulncheck: Tool{Module: "golang.org/x/vuln/cmd/govulncheck", Version: "v1.6.0", MinimumGo: "1.25.0", UpstreamGoMod: "https://github.com/golang/vuln/blob/v1.6.0/go.mod"}, CompatibilityGo: "1.24"}
}
