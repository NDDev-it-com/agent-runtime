...
func TestGoModuleSemanticContractAcceptsCanonicalTidyAndRejectsDrift(t *testing.T) {
	...
	mutations := []string{
		...
		strings.Replace(canonical, "go 1.25.0", "go 1.24.0", 1),
		strings.Replace(canonical, "\tgolang.org/x/sys v0.45.0\n", "", 1),
		strings.Replace(canonical, ")\n", "\tgolang.org/x/text v0.1.0\n)\n", 1),
		strings.Replace(canonical, "golang.org/x/sys v0.45.0", "golang.org/x/sys v0.44.0", 1),
		canonical + "replace golang.org/x/sys => ../sys\n",
		canonical + "exclude golang.org/x/sys v0.45.0\n",
...
func TestGoSumSemanticContractRejectsClosureAndDigestDrift(t *testing.T) {
	...
	invalid := []string{
		...
		strings.Replace(valid, "golang.org/x/mod v0.27.0", "golang.org/x/sys v0.45.0", 1),
	}
