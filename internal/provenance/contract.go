...
type Contract struct {
	...
	OwnerDatabaseID               int64           `json:"owner_database_id"`
	...
	IntegrationSignerLogin        string          `json:"integration_signer_login"`
	IntegrationSignerDatabaseID   int64           `json:"integration_signer_database_id"`
	IntegrationSignerNodeID       string          `json:"integration_signer_node_id"`
...
func (contract Contract) Validate() error {
	if contract.SchemaVersion != SchemaVersion || contract.Repository != "NDDev-it-com/agent-runtime" || contract.RepositoryDatabaseID != 1332584050 || contract.RepositoryNodeID != "R_kgDOT22ecg" || contract.OwnerLogin != "rldyourmnd" || contract.OwnerDatabaseID != 102828838 || contract.OwnerNodeID != "U_kgDOBiELJg" {
	...
	if contract.IntegrationOpenPGPFingerprint != "968479A1AFF927E37D1A566BB5690EEEBB952194" || contract.IntegrationOpenPGPSHA256 != "40ce89d21fb075092d256f9fbf62a1c19299d3282cb913d3e61d08235d0c491a" || contract.IntegrationOpenPGPStatus != "active" || contract.IntegrationSignerLogin != "web-flow" || contract.IntegrationSignerDatabaseID != 19864447 || contract.IntegrationSignerNodeID != "MDQ6VXNlcjE5ODY0NDQ3" || contract.TrustUpdatePolicy != "reviewed-contract-change" || contract.MergeMethod != "merge" {
		return errors.New("integration identity and merge method are canonical")
	}
	want := []RequiredCheck{
		{Context: "Analyze (go)", AppID: 15368, AppNodeID: "MDM6QXBwMTUzNjg=", AppSlug: "github-actions", WorkflowID: 333214507, Event: "dynamic"},
		{Context: "govulncheck", AppID: 15368, AppNodeID: "MDM6QXBwMTUzNjg=", AppSlug: "github-actions", WorkflowID: 333214464, Event: "pull_request"},
		{Context: "test (macos-latest)", AppID: 15368, AppNodeID: "MDM6QXBwMTUzNjg=", AppSlug: "github-actions", WorkflowID: 333214464, Event: "pull_request"},
		{Context: "test (ubuntu-latest)", AppID: 15368, AppNodeID: "MDM6QXBwMTUzNjg=", AppSlug: "github-actions", WorkflowID: 333214464, Event: "pull_request"},
	}
